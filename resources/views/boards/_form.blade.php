<div class="form-group row">
  <input type="text" class="form-control col-lg-10 col-md-10 m-1" id="title-input" placeholder="タイトル" name="title" value="{{ old('title', $title) }}">
</div>
<div class="row">
  <div class="markdown_field col-lg-5 col-md-10 m-1">
